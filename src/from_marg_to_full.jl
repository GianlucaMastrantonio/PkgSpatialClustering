...
function from_marg_to_full(iterations::Int64,
  ...
  for k in 1:obj_mixture_mcmc.Kmax
    ...
    obj_data_mcmc.sigma_mat[k].data .= Symmetric(obj_data_mcmc.sigma2[k] .* exp.(-obj_data_mcmc.rho[k] .* obj_data_mcmc.distance_mat))
  ...
  sampling_gp_cluster_for_marginal(iterations, obj_graph_mcmc, obj_graph_prop, obj_mixture_mcmc, obj_mixture_prop, obj_data_mcmc, obj_data_prop,obj_prior)
  for k in 1:obj_mixture_mcmc.Kmax
...
function from_full_to_marg(iterations::Int64,
  ...
  for k in 1:obj_mixture_mcmc.Kmax
    ...
    obj_data_mcmc.sigma_mat[k].data .= Symmetric(obj_data_mcmc.sigma2[k] .* exp.(-obj_data_mcmc.rho[k] .* obj_data_mcmc.distance_mat) + obj_data_mcmc.tau2[k] .* I(obj_data_mcmc.n_points))
